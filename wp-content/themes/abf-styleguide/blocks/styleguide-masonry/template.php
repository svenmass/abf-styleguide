                    ...
                    try {
                        ...
                        pswp.on('uiRegister', function() {
                            pswp.ui.registerElement({
                                ...
                                html: 'Download',
                                onInit: (el, pswp) => {
                                    el.style.cssText = 'color: white; background: rgba(0,0,0,0.5); padding: 8px 12px; border-radius: 4px; margin-right: 8px; text-decoration: none; font-size: 14px; display: none;';
                                    ...
                                    const updateDownloadButton = () => {
                                        ...
                                        if (currentSlide?.downloadUrl && currentSlide?.showDownload) {
                                            ...
                                            el.textContent = currentSlide.downloadText || 'Download';

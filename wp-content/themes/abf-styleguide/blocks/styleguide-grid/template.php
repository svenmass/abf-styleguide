...
$headline_size = get_field('sg_headline_size') ?: '24';
$headline_weight = get_field('sg_headline_weight') ?: '400';
$headline_color = get_field('sg_headline_color') ?: 'inherit';
...
// Prepare headline classes - only base class needed now
$headline_class_string = 'styleguide-grid-headline';
?>

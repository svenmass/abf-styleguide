            ...
            <div class="parallax-element parallax-element-<?php echo $element_number; ?>" data-element="<?php echo $element_number; ?>"<?php echo $element_style; ?>>
                ...
                <div class="parallax-content">
                    ...
                    <?php if ($show_button && $button_text && $button_url_value): ?>
                        ...
                        <?php // CSS-Hover entfernt - wird durch JavaScript ersetzt ?>
                        ...
                        <div class="parallax-button-wrapper">
                            ...
                            ?>
                            <a href="<?php echo $href_attr; ?>" class="parallax-button"
                               data-button-id="<?php echo esc_attr($block_id); ?>-btn-<?php echo $element_number; ?>"
                               ...
                               <?php echo $button_style_attr; ?><?php echo $target_attr; ?><?php echo $onclick_attr; ?>>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Button-Hover-Effekte mit JavaScript (IMMER aktiv - unabhängig von Sticky)
    const buttons = blockElement.querySelectorAll('.parallax-button[data-button-id]');
    buttons.forEach(function(button) {
        ...
        button.addEventListener('mouseenter', function() {
            ...
            if (hoverText) {
                this.style.setProperty('color', hoverText, 'important');
            }
        });
        ...
        button.addEventListener('mouseleave', function() {
            ...
            if (normalText) {
                this.style.setProperty('color', normalText, 'important');
            }
        });
    });

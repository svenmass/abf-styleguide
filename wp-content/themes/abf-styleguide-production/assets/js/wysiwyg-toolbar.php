...
class ABF_WYSIWYG_Toolbar {
    ...
    public function add_tinymce_plugins($plugin_array) {
        $plugin_array['abf_colors'] = get_template_directory_uri() . '/assets/js/tinymce-abf-colors.js';
        $plugin_array['abf_typography'] = get_template_directory_uri() . '/assets/js/tinymce-abf-typography.js';
        return $plugin_array;
    }
